...
public class Data {
    ...
    //-----------------------------------------
        ...
        //=== ВИКЛАДАЧІ(20) ===
        teacherService.crud().getRepository().add(new Teacher("T-01", "Бублик Володимир Васильович", dInf, "завідувач", "доктор наук", "професор", LocalDate.of(2001, 9, 1), "1.0", LocalDate.of(1965, 5, 12), "bublyk@ukma.edu.ua", "+380671112201"));
        teacherService.crud().getRepository().add(new Teacher("T-02", "Глибовець Андрій Миколайович", dInf, "доцент", "кандидат наук", "доцент", LocalDate.of(2008, 9, 1), "1.0", LocalDate.of(1980, 8, 24), "hlybovets@ukma.edu.ua", "+380671112202"));
        teacherService.crud().getRepository().add(new Teacher("T-03", "Симоненко Валерій Павлович", dNet, "доцент", "кандидат наук", "доцент", LocalDate.of(2010, 2, 1), "1.0", LocalDate.of(1975, 3, 15), "symonenko@ukma.edu.ua", "+380671112203"));
        teacherService.crud().getRepository().add(new Teacher("T-04", "Бойко Тарас Андрійович", dNet, "старший викладач", "доктор філософії", "немає", LocalDate.of(2018, 9, 1), "0.5", LocalDate.of(1990, 11, 2), "boyko@ukma.edu.ua", "+380671112204"));
        teacherService.crud().getRepository().add(new Teacher("T-05", "Іванов Олександр Володимирович", dMath, "професор", "доктор наук", "професор", LocalDate.of(1999, 9, 1), "1.0", LocalDate.of(1960, 1, 10), "ivanov@ukma.edu.ua", "+380671112205"));
        teacherService.crud().getRepository().add(new Teacher("T-06", "Петренко Олена Миколаївна", dMath, "асистент", "немає", "немає", LocalDate.of(2021, 9, 1), "0.5", LocalDate.of(1995, 7, 18), "petrenko.o@ukma.edu.ua", "+380671112206"));
        teacherService.crud().getRepository().add(new Teacher("T-07", "Франчук Оксана Вікторівна", dMulti, "доцент", "кандидат наук", "доцент", LocalDate.of(2012, 9, 1), "1.0", LocalDate.of(1982, 4, 30), "franchuk@ukma.edu.ua", "+380671112207"));
        teacherService.crud().getRepository().add(new Teacher("T-08", "Мельник Дмитро Сергійович", dMulti, "викладач", "доктор філософії", "немає", LocalDate.of(2020, 9, 1), "1.0", LocalDate.of(1992, 9, 14), "melnyk@ukma.edu.ua", "+380671112208"));

        teacherService.crud().getRepository().add(new Teacher("T-09", "Лук'яненко Ірина Григорівна", dFin, "професор", "доктор наук", "професор", LocalDate.of(1995, 9, 1), "1.0", LocalDate.of(1962, 12, 5), "lukianenko@ukma.edu.ua", "+380671112209"));
        teacherService.crud().getRepository().add(new Teacher("T-10", "Шевченко Юлія Олегівна", dFin, "старший викладач", "кандидат наук", "немає", LocalDate.of(2015, 9, 1), "1.0", LocalDate.of(1985, 2, 22), "shevchenko@ukma.edu.ua", "+380671112210"));
        teacherService.crud().getRepository().add(new Teacher("T-11", "Юргелевич Сергій Володимирович", dEcon, "доцент", "кандидат наук", "доцент", LocalDate.of(2005, 9, 1), "1.0", LocalDate.of(1978, 10, 11), "yurhelevych@ukma.edu.ua", "+380671112211"));
        teacherService.crud().getRepository().add(new Teacher("T-12", "Коваленко Максим Петрович", dEcon, "викладач", "доктор філософії", "немає", LocalDate.of(2019, 9, 1), "0.5", LocalDate.of(1991, 6, 8), "kovalenko@ukma.edu.ua", "+380671112212"));
        teacherService.crud().getRepository().add(new Teacher("T-13", "Пітцик Марія Володимирівна", dMark, "доцент", "кандидат наук", "доцент", LocalDate.of(2010, 9, 1), "1.0", LocalDate.of(1980, 1, 25), "pitsyk@ukma.edu.ua", "+380671112213"));
        teacherService.crud().getRepository().add(new Teacher("T-14", "Савченко Ірина Вікторівна", dMark, "асистент", "немає", "немає", LocalDate.of(2022, 9, 1), "0.5", LocalDate.of(1996, 4, 12), "savchenko@ukma.edu.ua", "+380671112214"));

        teacherService.crud().getRepository().add(new Teacher("T-15", "Козюбра Микола Іванович", dZagal, "професор", "доктор наук", "професор", LocalDate.of(1992, 9, 1), "1.0", LocalDate.of(1955, 11, 8), "koziubra@ukma.edu.ua", "+380671112215"));
        teacherService.crud().getRepository().add(new Teacher("T-16", "Ткачук Олег Степанович", dZagal, "доцент", "кандидат наук", "доцент", LocalDate.of(2007, 9, 1), "1.0", LocalDate.of(1975, 8, 19), "tkachuk@ukma.edu.ua", "+380671112216"));
        teacherService.crud().getRepository().add(new Teacher("T-17", "Безклубний Ігор Анатолійович", dPrivat, "доцент", "кандидат наук", "доцент", LocalDate.of(2011, 9, 1), "1.0", LocalDate.of(1981, 2, 14), "bezklubny@ukma.edu.ua", "+380671112217"));
        teacherService.crud().getRepository().add(new Teacher("T-18", "Мороз Анастасія Ігорівна", dPrivat, "викладач", "доктор філософії", "немає", LocalDate.of(2020, 9, 1), "1.0", LocalDate.of(1993, 10, 5), "moroz@ukma.edu.ua", "+380671112218"));
        teacherService.crud().getRepository().add(new Teacher("T-19", "Азаров Денис Сергійович", dKrym, "професор", "доктор наук", "професор", LocalDate.of(2003, 9, 1), "1.0", LocalDate.of(1972, 7, 30), "azarov@ukma.edu.ua", "+380671112219"));
        teacherService.crud().getRepository().add(new Teacher("T-20", "Романенко Віктор Павлович", dKrym, "старший викладач", "кандидат наук", "немає", LocalDate.of(2016, 9, 1), "0.5", LocalDate.of(1986, 5, 21), "romanenko@ukma.edu.ua", "+380671112220"));
